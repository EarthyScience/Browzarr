...
#description
A powerful framework for visualizing, exploring, and analyzing **Zarr and NetCDF datasets** - _runs entirely in the browser, whether your data is local or in the cloud._
...
#description
Use Browzarr online with no setup, or run it fully [offline]{.text-primary} via npm or Julia.
...
#features
  ...
  to: /getting-started/npm
  ---
  #title
  [npm]{.text-primary} — offline-friendly
  #description
  ...
  to: /getting-started/julia
  ---
  #title
  [Julia]{.text-primary} — Browzarr.jl
  #description
  `Pkg.add("Browzarr")` and call `browzarr()` with a local path or remote store URL.
  :::
::
