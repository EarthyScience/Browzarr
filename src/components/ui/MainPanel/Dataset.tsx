...
const DescriptionContent = ({
	...
	return (
		<div className="grid gap-1">
			<div className="mb-2">
				<h1 className="text-lg font-bold">{title ? title : "Store"}</h1>
				<p
...
const Dataset = ({
	...
	const [openDescriptionPopover, setOpenDescriptionPopover] =
		useState<boolean>(false);
								...
								<div className="mt-2">
									{isSafari ? (
										<div className="p-3 rounded-md border border-yellow-600 text-tiny max-w-[300px]">
											<strong>
												Local folder upload is not supported in Safari.
											</strong>{" "}
